...
public class LatteClsFieldImpl extends LatteCompositeElementImpl implements LatteClsField {

  public LatteClsFieldImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LatteVisitor visitor) {
    visitor.visitClsField(this);
  }
