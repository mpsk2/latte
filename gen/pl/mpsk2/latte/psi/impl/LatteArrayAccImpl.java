...
public class LatteArrayAccImpl extends LatteCompositeElementImpl implements LatteArrayAcc {

  public LatteArrayAccImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LatteVisitor visitor) {
    visitor.visitArrayAcc(this);
  }
